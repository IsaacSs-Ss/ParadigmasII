...
public class pBajaMateria extends javax.swing.JPanel {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        int opcion = javax.swing.JOptionPane.showConfirmDialog(this,
                "¿Está seguro que desea eliminar a " + cargarMaterias(cargarId()).getNombre() + " " + cargarMaterias(cargarId()) + "?",
                "Confirmar Eliminación",
                javax.swing.JOptionPane.YES_NO_OPTION);
        if (opcion == javax.swing.JOptionPane.YES_OPTION) {
            Materia m = cargarMaterias(cargarId());
            materias.remove(m);
            guardar(materias, "materias.dat");
            javax.swing.JOptionPane.showMessageDialog(this, "La carrera " + m.getNombre() + " se ha eliminado exitósamente :)");
        }
    ...
    public Materia cargarMaterias(int i) {
        Materia a = this.materias.get(i);
        return a;
    }

    public void llenarCampos(int iterador) {
        Materia m = cargarMaterias(iterador);
